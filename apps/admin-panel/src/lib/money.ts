/**
 * Central money formatter — the SINGLE display point for every ₦ amount in the admin panel.
 *
...
/** Convert an admin-entered major-unit amount to the stored representation (forms → API). */
