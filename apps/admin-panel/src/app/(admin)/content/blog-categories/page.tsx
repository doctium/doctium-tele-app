...
export default function BlogCategoriesPage() {
  ...
  const handleDelete = async (id: string) => {
    ...
    await apiClient.delete(`/admin/media/blog-categories/${id}`);
    ...
    try {
      if (form.id) {
        await apiClient.patch(
          `/admin/media/blog-categories/${form.id}`,
          payload,
        );
        toast.success("Category updated");
      } else {
        await apiClient.post("/admin/media/blog-categories", payload);
  ...
  return (
    <div className="space-y-5">
      ...
      <p className="text-sm text-gray-500 -mt-2">
        Used to group blog posts. The slug is auto-generated from the name if
        left blank.
      </p>
